...
function MainContent(): JSX.Element {
    return(
        ...
        placeName= {"Oaxaca"}
        country= {"Mexico"}
        image= {{image: "https://media.istockphoto.com/photos/hiking-to-a-mountain-in-san-jose-del-pacifico-mexico-picture-id1199438709?k=20&m=1199438709&s=612x612&w=0&h=yDGoRPNQ6Wc-U9tBVtrbt4rW4fY-nS72zPBUp49FXpU=", alt: "A cat looks over cloudy mountains"}}
        ...
        placeName= {"Granada"}
        country= {"Spain"}
        image= {{image: "https://media.istockphoto.com/photos/the-alhambra-picture-id182727232?k=20&m=182727232&s=612x612&w=0&h=w75AwT84vCxxG4De-3a6uheAmumI9Vw_rfmpTOrcspM=", alt: "Alhambra with snowy mountains behind"}}
